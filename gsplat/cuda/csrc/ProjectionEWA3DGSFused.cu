...
__global__ void projection_ewa_3dgs_fused_fwd_kernel(
    ...
    scalar_t *__restrict__ ray_planes,   // [B, C, N, 2] optional
    scalar_t *__restrict__ normals       // [B, C, N, 3] optional
) {
...
__global__ void projection_ewa_3dgs_fused_bwd_kernel(
    ...
    const scalar_t *__restrict__ v_ray_ts,        // [B, C, N]
    const scalar_t *__restrict__ v_ray_planes,    // [B, C, N, 2]
