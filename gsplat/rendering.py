...
def rasterization(
    ...
    # Debug: print dimensions of ray_ts, ray_planes, normals
    print(f"[Debug] ray_ts shape: {ray_ts.shape}")
    print(f"[Debug] ray_ts range: [{float(ray_ts.min()):.6f}, {float(ray_ts.max()):.6f}]")
